...
CREATE TABLE propertyvalue (
  ...
  PRIMARY KEY (id),
  CONSTRAINT fk_propertyvalue_product FOREIGN KEY (productId) REFERENCES product (id) on delete cascade on update cascade,
  CONSTRAINT fk_propertyvalue_property FOREIGN KEY (propertyId) REFERENCES property (id) on delete cascade on update cascade
) ENGINE=INNODB DEFAULT CHARSET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
...
insert into user(id, name, pwd, role) values
(1, 'admin', 'admin', 'administrator'), #管理员
(2, 'user', 'user', null); #普通用户
...
CREATE TABLE orderitem (
  ...
  reviewStatus varchar(10) DEFAULT 'no',
  paymentStatus varchar(10) DEFAULT 'no',
  PRIMARY KEY (id),
